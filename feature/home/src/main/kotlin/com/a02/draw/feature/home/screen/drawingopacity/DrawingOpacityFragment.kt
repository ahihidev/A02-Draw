...
class DrawingOpacityFragment :
            ...
            launch {
                viewModel.effects.collect { effect ->
                    when (effect) {
                        ...
                        DrawingOpacityEffect.CaptureCanvas -> captureCanvas()
    ...
    private fun captureCanvas() {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            if (uri != null) viewModel.onAction(DrawingOpacityAction.Captured(uri)) else {
    ...
    private fun saveBitmap(context: Context, source: Bitmap): String? {
        val output = source.cropTo(viewModel.state.value.session.cropRatio.outputRatio)
